...
class FSRCNNTrainer(object):
    ...
    def build_model(self):
        self.model = FSRCNN(num_channels=1, upscale_factor=self.upscale_factor).to(self.device)
    ...
    def train(self):
        ...
        for batch_num, (data, target) in enumerate(self.training_loader):
            ...
            loss.backward()
            self.optimizer.step()
            #sprogress_bar(batch_num, len(self.training_loader), 'Loss: %.4f' % (train_loss / (batch_num + 1)))
